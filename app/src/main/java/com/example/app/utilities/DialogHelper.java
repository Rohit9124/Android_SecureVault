...
import com.example.app.encryption.HashUtils;
...
public class DialogHelper {
    ...
    private static void applyDialogBackground(AlertDialog dialog) {
    ...
    public static void showChangePasswordDialog(Context context,
        ...
        builder.setTitle(R.string.settings_change_password)
                .setPositiveButton(R.string.update_alertdialog_yes, (dialog, id) -> {
                    ...
                    String hashedPasswordFromSharedPrefs =
                            encryptedSharedPreferences.getString("password", "");

                    try {
                        if (HashUtils.verifyPassword(inputOldPassword, hashedPasswordFromSharedPrefs)
                                && inputNewPassword.length() >= 4
                                && inputNewPassword.equals(inputConfirmNewPassword)) {

                            SharedPreferences.Editor editor =
                                    encryptedSharedPreferences.edit();

                            String hashedPassword =
                                    HashUtils.hashPassword(inputNewPassword);
                            ...
                            Toast.makeText(context,
                                    R.string.password_must_be_at_least_4_characters_long,
                ...
                .setNegativeButton(R.string.update_alertdialog_no,
    ...
    public static void showImportingDialog(Context context, Uri fileURL) {
        ...
        builder.setTitle(R.string.import_database)
                .setPositiveButton(R.string.confirm, (dialog, id) -> {
                    ...
                    try {
                        DatabaseHelper.importJsonToDatabase(context,
                                fileURL,
                                password);
                    } catch (NoSuchAlgorithmException | InvalidKeySpecException e) {
                        Log.e("DialogHelper", "Import error", e);
                    }
                })
                .setNegativeButton(R.string.cancel,
                        (dialog, id) -> dialog.cancel());
