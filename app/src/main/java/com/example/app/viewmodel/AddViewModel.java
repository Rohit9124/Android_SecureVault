...
public class AddViewModel extends ViewModel {
    ...
    public void addEntry(Context context, String name, String email, String password, String website) {
        ...
        if (!name.isEmpty() && !email.isEmpty() && password.length() >= 4) {
            ...
            if (DatabaseHelper.checkIfAccountAlreadyExist(context, name, email)) {
                ...
                DatabaseHelper.addEntry(context, name, email, password, website);
